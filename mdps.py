...
# Home Page
if selected == 'Home':
    st.title("Welcome to the Health Assistant Web Application")
    st.write("""
    This Web Application is designed to help users predict the likelihood of developing certain diseases based on their input features. With the use of trained and tested machine learning models, we provide predictions for Diabetes, Heart Disease, and Parkinson's Disease.
    """)
    st.write("## How to Use:")
    st.write("""
    1. Navigate to the Main Menu(>) located in the top-left corner of the screen.
    2. Click on the desired tab among 'Diabetes Prediction', 'Heart Disease Prediction', and 'Parkinsons Prediction' to access prediction tools for specific diseases.
